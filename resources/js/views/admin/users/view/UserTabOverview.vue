<script setup>
import BookInvoiceTable from './BookInvoiceTable.vue'
...
const resolveBookProgressVariant = progress => {
  if (progress <= 25)
    return 'error'
...
<template>
  <VRow>
    <VCol cols="12">
      <VCard title="Book's Projects List">
        <VDivider />
            ...
            >
              ...
              <td>
                ...
                <VProgressLinear
                  ...
                  rounded
                  :color="resolveBookProgressVariant(project.progress)"
                />
              </td>
    ...
    <VCol cols="12">
      <!-- 👉 Activity timeline -->
      <VCard title="Book Activity Timeline">
        <VCardText>
          <VTimeline
            density="compact"
            align="start"
